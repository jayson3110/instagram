...
,followers = [], username:profileUsername},followerCount,setFollowerCount,  photosCount}) {
	const {user} = useUser();
	...
	return <div className="grid grid-cols-3 gap-4 justify-between mx-auto max-w-screen-lg">
	     <div className="container flex justify-center">
            {user.username && (
	         <img className="rounded-full h-40 w-40 flex"
	              ...
	              src={`/images/avatar/${profileUsername}.jpg`}
	     ...
	     <div className="flex items-center justify-center flex-col col-span-2">
	        ...
	        <div className="container mt-4">
	            ...
	            <p className className="font-medium">{!fullName ?
	            	<Skeleton count={1} width={677} height={24} /> : fullName
	            } 
